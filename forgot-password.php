...
$ForgetEmail = mysqli_real_escape_string($conn,$_POST['ForgetEmail']);

$query_Admin = mysqli_query($conn,"SELECT * FROM login WHERE email='$ForgetEmail'") or die(mysqli_error($query_Admin)); 
    if(mysqli_num_rows($query_Admin)>0){
  $verification_code=(rand(10,1000000));
...
.gradient { background: linear-gradient(to right, #1728e4 0%,#0f508c 100%); }

.btn-secondary { border-radius: 10px; background: linear-gradient(to right, #1728e4  0%,#0f508c 100%); }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td class="pb-50" style="padding-bottom: 50px;padding-top: 50px;">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
Please enter the below verification code to reset your password
</td>
</tr>
<tr>
<td align="center">
...
<tr>
<td class="btn-16 c-white l-white" bgcolor="#1781e4" style="font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:PT Sans, Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff;">
<span class="link c-white" style="text-decoration:none; color:#ffffff;">'.$verification_code.'</span>
</a>
</td>
</tr>
</table>
...
try {
$mail->isSMTP();  
$mail->Host = 'sphynx5768.com';
$mail->SMTPAuth = true;
$mail->Username = 'info@sphynx5768.com';
$mail->Password = 'L_N]tZ8%H{6B'; 
$mail->SMTPSecure = 'ssl';
$mail->Port = 465;
$mail->setFrom('info@sphynx5768.com', 'Sphynx5768');
$mail->addAddress($ForgetEmail);
$mail->isHTML(true);
$mail->Subject = 'Sphynx5768! Forgot Your Password?';
$mail->Body    =  $html;
$mail->send();
    ...
    <div class="card-body">
      ...
      <form action="" method="post">
        <div class="input-group mb-3">
          <input type="email" name="ForgetEmail" required class="form-control" placeholder="Email">
