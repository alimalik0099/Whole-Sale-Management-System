...
$query = "SELECT * FROM suppliers WHERE supplier_no='$supplier_no'";
   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php echo $row['name'];?> Product Details</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo $row['name'];?> Products</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped" data-order='[[ 0, "desc" ]]'>
                  ...
                  <tbody>
                    <?php
                    $query = "SELECT * FROM products WHERE supplier='$supplier_no' ORDER BY id DESC";
                    $result = mysqli_query($conn, $query);  
